...
all_nms_grls = pd.read_excel(r"C:\Users\sfell\OneDrive\Streamlit_app\data\2021girlsnames.xlsx", 
                sheet_name="6", skiprows=6)

   
all_nms_boys = pd.read_excel(r"C:\Users\sfell\OneDrive\Streamlit_app\data\2021boysnamesupdated1.xlsx", 
                sheet_name="6", skiprows=6)
